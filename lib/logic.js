...
function addReport(data){
	...
	patient.data[data.title] = data.description;

	return getParticipantRegistry('org.healthcare.records.Member')
	.then(function (memberRegistry) {

		var event = getFactory().newEvent('org.healthcare.records', 'MemberEvent');
		event.memberTransaction = addData;
		emit(event);
...
function updateSummary(summary){
	...
	for(var datatitle in data.summary){
		patient.summary[datatitle] = data.summary[datatitle];
	}
